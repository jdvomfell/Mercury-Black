...
int createWisp(World * world, float x, float y, MetaballHandler * metaballHandler) {
	...
	world->scriptParameters[entityID].specialTimer1 = 0.0f;
	world->scriptParameters[entityID].specialTimer2 = 0.0f;
	world->scriptParameters[entityID].specialTimer3 = 0.0f;
	world->scriptParameters[entityID].attackTimer = 0.0f;
